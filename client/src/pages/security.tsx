    ...
    <div className="min-h-screen bg-background">
      ...
      <footer className="border-t bg-card/50 py-8">
        <div className="max-w-7xl mx-auto px-4 text-center text-xs text-muted-foreground">
          <p>{de ? "© 2024 SwizKote Bank AG — " : "© 2024 SwizKote Bank SA — "}<Link href="/terms" className="hover:text-foreground">{de ? "AGB" : "CGU"}</Link> · <Link href="/privacy" className="hover:text-foreground">{de ? "Datenschutz" : "Confidentialité"}</Link> · <Link href="/legal" className="hover:text-foreground">{de ? "Impressum" : "Mentions légales"}</Link></p>
        </div>
      </footer>
    </div>
  );
