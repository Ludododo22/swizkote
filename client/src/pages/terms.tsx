...
const ARTICLES = {
  ...
  fr: [
    { title: "Art. 1 — Définitions et champ d'application", content: "Les présentes Conditions Générales d'Utilisation (ci-après « CGU ») régissent l'ensemble des relations contractuelles entre SwizKote Bank SA (ci-après « la Banque »), société anonyme de droit suisse dont le siège est situé Rue du Rhône 42, 1204 Genève, Suisse, et toute personne physique ou morale (ci-après « le Client ») utilisant les services bancaires et la plateforme digitale de SwizKote Bank.\n\nLa Banque est agréée et soumise à la surveillance de l'Autorité fédérale de surveillance des marchés financiers (FINMA), conformément à la Loi fédérale sur les banques (LB) du 8 novembre 1934.\n\nL'utilisation de tout service de SwizKote Bank implique l'acceptation sans réserve des présentes CGU dans leur intégralité." },
    { title: "Art. 2 — Ouverture et gestion de compte", content: "2.1 Conditions d'ouverture. L'ouverture d'un compte auprès de SwizKote Bank est soumise à la fourniture de documents d'identité valides, à la vérification KYC conformément à la LBA et aux directives FINMA. La Banque se réserve le droit de refuser toute demande d'ouverture de compte sans avoir à se justifier.\n\n2.2 Identification. Le Client est seul responsable de la confidentialité de ses identifiants de connexion. Tout accès réalisé avec les identifiants du Client est présumé émaner de ce dernier, sauf preuve contraire apportée dans les 48 heures." },
    { title: "Art. 3 — Services bancaires et transactions", content: "3.1 Virements. Les virements SEPA sont exécutés selon les délais standards D+1 pour les opérations intrabancaires et D+2 pour les virements interbancaires, hors jours fériés.\n\n3.2 Limites de transactions. Des limites quotidiennes et hebdomadaires s'appliquent aux virements et retraits, telles que définies dans la brochure tarifaire.\n\n3.3 Révocabilité. Un virement peut être révoqué uniquement avant son exécution définitive.\n\n3.4 Responsabilité en cas de fraude. En cas de transactions frauduleuses, le Client doit en informer la Banque dans les meilleurs délais et au plus tard dans les 13 mois suivant la date de débit." },
    { title: "Art. 4 — Tarification et frais bancaires", content: "Les frais applicables aux différents services sont définis dans la brochure tarifaire en vigueur, disponible sur notre site web et remise au Client lors de l'ouverture du compte. SwizKote Bank se réserve le droit de modifier sa tarification avec un préavis de 30 jours calendaires adressé au Client par voie électronique." },
    { title: "Art. 5 — Crédits et prêts bancaires", content: "5.1 Octroi de crédit. L'octroi de tout crédit est subordonné à une analyse de solvabilité préalable du Client, incluant la consultation des centrales d'information sur le crédit (ZEK, IKO). La Banque se réserve le droit de refuser toute demande sans avoir à se justifier.\n\n5.2 Défaut de paiement. En cas de défaut de paiement, des intérêts de retard au taux légal majoré de 2 points seront appliqués automatiquement dès le 10ème jour suivant l'échéance." },
    { title: "Art. 6 — Sécurité et authentification forte", content: "6.1 Authentification forte (2FA). La Banque applique l'authentification forte du client (SCA) pour l'ensemble des connexions et transactions conformément aux recommandations de la FINMA. Le Client s'engage à ne jamais partager ses codes OTP ou autres facteurs d'authentification.\n\n6.2 Signalement d'incidents. Tout incident de sécurité ou accès suspect doit être signalé immédiatement via la messagerie sécurisée du portail client ou par téléphone au +41 22 000 00 00." },
    { title: "Art. 7 — Secret bancaire et protection des données", content: "7.1 Secret bancaire. SwizKote Bank est soumise au secret bancaire suisse tel que défini à l'article 47 de la Loi fédérale sur les banques (LB). Ce secret protège les informations relatives aux avoirs, aux transactions et à la situation financière du Client.\n\n7.2 Protection des données. Conformément à la LPD révisée et au RGPD pour les résidents de l'UE, les données personnelles du Client sont traitées licitement, de bonne foi et de manière proportionnée.\n\n7.3 Conservation des données. Les données sont conservées pendant la durée de la relation bancaire et pendant 10 ans minimum après la clôture du compte." },
    { title: "Art. 8 — Résiliation et clôture de compte", content: "Le Client peut résilier le contrat bancaire et demander la clôture de son compte à tout moment par notification écrite, sous réserve de l'exécution de toutes les obligations en cours. La Banque procède à la clôture effective dans un délai de 30 jours suivant la réception de la demande complète.\n\nLa Banque peut procéder à la résiliation unilatérale avec un préavis de 30 jours en cas de violation des présentes CGU, de suspicion raisonnable de fraude ou d'inactivité du compte pendant 5 années consécutives." },
    { title: "Art. 9 — Droit applicable et for juridique", content: "Les présentes CGU et toutes les relations contractuelles sont régies exclusivement par le droit suisse. Les parties conviennent d'un for exclusif à Genève, sous réserve du droit du Client de saisir le Médiateur bancaire suisse (www.bankingombudsman.ch).\n\nLes présentes CGU ont été révisées en novembre 2024 et entrent en vigueur le 1er janvier 2025." },
  ],
  en: [
  ...
  it: [
    ...
    { title: "Art. 4 — Tariffazione e commissioni bancarie", content: "Le commissioni applicabili ai vari servizi sono definite nel tariffario vigente disponibile sul nostro sito web e consegnato al Cliente all'apertura del conto. SwizKote Bank si riserva il diritto di modificare la propria tariffazione con un preavviso di 30 giorni di calendario." },
    ...
    { title: "Art. 8 — Risoluzione e chiusura del conto", content: "Il Cliente può risolvere il contratto bancario e richiedere la chiusura del conto in qualsiasi momento mediante comunicazione scritta, fatte salve l'esecuzione di tutti gli obblighi in sospeso. La Banca procede alla chiusura entro 30 giorni dal ricevimento della domanda completa.\n\nLa Banca può recedere con un preavviso di 30 giorni in caso di violazione delle presenti CGU, ragionevole sospetto di frode o inattività del conto per 5 anni consecutivi." },
